      ...
      <div className="print:hidden">
        ...
        <div className="mt-2 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            ...
            <ImprimirBoton className="flex items-center gap-2 rounded-md bg-gradient-to-r from-amber-500 to-orange-500 px-5 py-3 text-sm font-bold text-white shadow-lg shadow-amber-500/30 transition-all">
              🖨️ Imprimir
            </ImprimirBoton>
          </div>
        </div>
        ...
        <form method="get" className="mt-5 flex flex-wrap items-end gap-3 rounded-2xl border-2 border-[#e2e8f0] dark:border-slate-700 bg-white dark:bg-[#141a2e] p-5">
          ...
          <button
            type="submit"
            className="rounded-md bg-amber-500 px-5 py-2.5 text-sm font-bold text-white shadow-sm shadow-amber-500/30 transition-all hover:bg-amber-600"
          >
            Filtrar
          </button>
        </form>
