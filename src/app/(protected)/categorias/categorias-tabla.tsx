  ...
  return (
    <div>
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-extrabold text-[#1e293b]">🏷️ Categorías</h1>
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Filtrar..."
              className="rounded-2xl border-2 border-[#e2e8f0] bg-white py-2.5 pr-4 pl-10 text-sm font-medium text-[#1e293b] outline-none transition-all focus:border-violet-500 focus:ring-4 focus:ring-violet-100"
            />
          </div>
          <Link
      ...
      <div className="mt-6 overflow-hidden rounded-3xl border-2 border-[#e2e8f0] bg-white shadow-lg shadow-slate-500/5">
        {categorias.length === 0 ? (
          ...
          <p className="p-12 text-center text-sm font-medium text-[#64748b]">Ninguna coincide con “{filtro}”.</p>
        ) : (
          <table className="w-full text-left text-[13.5px]">
            ...
            <tbody>
              {filtradas.map((c) => (
                <tr key={c.id} className="border-b border-[#f1f5f9] text-[#1e293b] transition-colors hover:bg-violet-50/40">
                  ...
                  <td className="px-6 py-4 text-right whitespace-nowrap">
                    <Link
                      ...
                      className="inline-flex h-9 w-9 items-center justify-center rounded-xl text-[#64748b] transition-all hover:bg-violet-100 hover:text-violet-600"
                      title="Editar"
                    >
