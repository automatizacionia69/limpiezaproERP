...
const MOTIVOS_ANULACION = MOTIVOS_NOTA_CREDITO.filter((m) => m.anula)

export default async function AnularDocumentoPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-2xl rounded-3xl border-2 border-red-100 bg-white p-8 shadow-lg shadow-red-500/5 dark:border-red-900/30 dark:bg-[#141a2e]">
        <h1 className="text-xl font-extrabold text-[#1e293b] dark:text-slate-100">🚫 Anular documento</h1>
