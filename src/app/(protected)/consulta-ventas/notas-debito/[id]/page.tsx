  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between print:hidden">
        ...
        <ImprimirBoton className="flex items-center gap-2 rounded-md bg-gradient-to-r from-amber-500 to-orange-500 px-6 py-3 text-sm font-bold text-white shadow-lg shadow-amber-500/30 transition-all">
          🖨️ Imprimir
        </ImprimirBoton>
      </div>
