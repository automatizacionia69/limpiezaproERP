  ...
  return (
    <div>
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-extrabold text-[#1e293b]">📏 Unidades de medida</h1>
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Filtrar..."
              className="rounded-2xl border-2 border-[#e2e8f0] bg-white py-2.5 pr-4 pl-10 text-sm font-medium text-[#1e293b] outline-none transition-all focus:border-fuchsia-500 focus:ring-4 focus:ring-fuchsia-100"
            />
          </div>
          <Link
            href="/unidades/nueva"
            className="flex items-center gap-2 rounded-2xl bg-gradient-to-r from-fuchsia-500 to-pink-500 px-6 py-3 text-sm font-bold text-white shadow-lg shadow-fuchsia-500/30 transition-all hover:-translate-y-0.5 hover:shadow-xl hover:shadow-fuchsia-500/40"
          >
      ...
      <div className="mt-6 overflow-hidden rounded-3xl border-2 border-[#e2e8f0] bg-white shadow-lg shadow-slate-500/5">
        {unidades.length === 0 ? (
          ...
          <table className="w-full text-left text-[13.5px]">
            ...
            <tbody>
              {filtradas.map((u) => (
                <tr key={u.id} className="border-b border-[#f1f5f9] text-[#1e293b] transition-colors hover:bg-fuchsia-50/40">
                  ...
                  <td className="px-6 py-4 text-right whitespace-nowrap">
                    <Link
                      ...
                      className="inline-flex h-9 w-9 items-center justify-center rounded-xl text-[#64748b] transition-all hover:bg-fuchsia-100 hover:text-fuchsia-600"
                      title="Editar"
                    >
