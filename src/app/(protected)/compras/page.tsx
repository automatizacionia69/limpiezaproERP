    ...
    <div>
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/proveedores"
            className="rounded-2xl border-2 border-[#e2e8f0] dark:border-slate-700 bg-white dark:bg-[#141a2e] px-5 py-3 text-sm font-bold text-[#1e293b] dark:text-slate-100 transition-all hover:border-cyan-300 hover:bg-cyan-50"
          >
            Proveedores
          </Link>
          <Link
